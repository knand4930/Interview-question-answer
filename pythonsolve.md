...
This document contains a series of Python programming examples covering basic to intermediate concepts. Each example includes a problem statement, explanation, input, output, and the corresponding Python code.

## Table of Contents
1. [Hello World](#1-hello-world)
2. [Basic Addition](#2-basic-addition)
...
6. [Modulo Operation](#6-modulo-operation)
7. [Boolean Comparison](#7-boolean-comparison)
8. [String Length](#8-string-length)
9. [List Creation](#9-list-creation)
10. [List Indexing](#10-list-indexing)
11. [String Uppercase](#11-string-uppercase)
12. [Type Checking](#12-type-checking)
13. [Float Conversion](#13-float-conversion)
14. [List Append](#14-list-append)
15. [Dictionary Creation](#15-dictionary-creation)
16. [Dictionary Access](#16-dictionary-access)
17. [Range Function](#17-range-function)
18. [String Slicing](#18-string-slicing)
19. [List Slicing](#19-list-slicing)
20. [String Replace](#20-string-replace)
21. [List Sum](#21-list-sum)
22. [String Split](#22-string-split)
23. [List Maximum](#23-list-maximum)
24. [String Contains](#24-string-contains)
25. [List Count](#25-list-count)
26. [String Reverse](#26-string-reverse)
27. [List Reverse](#27-list-reverse)
28. [Tuple Creation](#28-tuple-creation)
29. [Set Creation](#29-set-creation)
30. [Dictionary Keys](#30-dictionary-keys)
31. [String Lowercase](#31-string-lowercase)
32. [List Insert](#32-list-insert)
33. [String Join](#33-string-join)
34. [Absolute Value](#34-absolute-value)
35. [Power Operation](#35-power-operation)
36. [Round Function](#36-round-function)
37. [String Strip](#37-string-strip)
38. [List Remove](#38-list-remove)
39. [Dictionary Values](#39-dictionary-values)
40. [String Find](#40-string-find)
41. [List Pop](#41-list-pop)
42. [String Count](#42-string-count)
43. [List Extend](#43-list-extend)
44. [Dictionary Update](#44-dictionary-update)
45. [Set Union](#45-set-union)
46. [String Startswith](#46-string-startswith)
47. [List Clear](#47-list-clear)
48. [String Endswith](#48-string-endswith)
49. [Tuple Indexing](#49-tuple-indexing)
50. [Set Intersection](#50-set-intersection)
51. [String Title](#51-string-title)
52. [List Index](#52-list-index)
53. [Dictionary Get](#53-dictionary-get)
54. [Set Difference](#54-set-difference)
55. [String Replace All](#55-string-replace-all)
56. [List Copy](#56-list-copy)
57. [Tuple Length](#57-tuple-length)
58. [String Isdigit](#58-string-isdigit)
59. [Set Add](#59-set-add)
60. [String Swapcase](#60-string-swapcase)
61. [List Sort](#61-list-sort)
62. [Dictionary Pop](#62-dictionary-pop)
63. [String Center](#63-string-center)
64. [List Minimum](#64-list-minimum)
65. [Set Remove](#65-set-remove)
66. [String Ljust](#66-string-ljust)
67. [Tuple Count](#67-tuple-count)
68. [String Isalpha](#68-string-isalpha)
69. [List Insert Multiple](#69-list-insert-multiple)
70. [Dictionary Items](#70-dictionary-items)
71. [String Zfill](#71-string-zfill)
72. [Set Discard](#72-set-discard)
73. [List Multiplication](#73-list-multiplication)
74. [String Partition](#74-string-partition)
75. [Enumerate Basic](#75-enumerate-basic)
76. [Simple If-Else](#76-simple-if-else)
77. [For Loop Sum](#77-for-loop-sum)
78. [While Loop Countdown](#78-while-loop-countdown)
79. [List Comprehension Basic](#79-list-comprehension-basic)
80. [Function Definition](#80-function-definition)
81. [Multiple Return Values](#81-multiple-return-values)
82. [Default Parameters](#82-default-parameters)
83. [Lambda Function](#83-lambda-function)
84. [Filter Function](#84-filter-function)
85. [Map Function](#85-map-function)
86. [Exception Handling](#86-exception-handling)
87. [String Format](#87-string-format)
88. [List Comprehension with Condition](#88-list-comprehension-with-condition)
89. [Dictionary Comprehension](#89-dictionary-comprehension)
90. [Nested List Access](#90-nested-list-access)
91. [String Formatting f-strings](#91-string-formatting-f-strings)
92. [Zip Function](#92-zip-function)
93. [Any Function](#93-any-function)
94. [All Function](#94-all-function)
95. [Sorted Function](#95-sorted-function)
96. [Reversed Function](#96-reversed-function)
97. [Set Comprehension](#97-set-comprehension)
98. [Nested Dictionary](#98-nested-dictionary)
99. [List Slice Assignment](#99-list-slice-assignment)
100. [String Translate](#100-string-translate)
101. [For Loop with Enumerate](#101-for-loop-with-enumerate)
102. [Nested For Loops](#102-nested-for-loops)
103. [Break Statement](#103-break-statement)
104. [Continue Statement](#104-continue-statement)
105. [Else with For Loop](#105-else-with-for-loop)
106. [Multiple Assignment](#106-multiple-assignment)
107. [Swap Variables](#107-swap-variables)
108. [Variable Arguments *args](#108-variable-arguments-args)
...
**Explanation**: Use a loop to find the largest element without using max().  
**Input**: [10, 5, 8, 20, 3]  
...
**Explanation**: Use the values låter() method to extract dictionary values.  
...
```python
list_comprehension = [x for x in range(1, 11) if x % 2 == 0]
print(list_comprehension)
```
...
num_list = [1, 2, 3]
char_list = ["a", "b", "c"]
print(list(zip(num_list, char_list)))
```
...
```python
nested_dict = {'lang': {'name': 'Python', 'version': 3.9}}
print(nested_dict['lang']['name'])
```
...
print(str_var.translate(remove_vowels))
```
